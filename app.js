    ...
    function renderDeckList(playerId) {
      ...
      // 按类型分组
      const typeOrder = ['shikigami', 'summon', 'spell', 'battle', 'form', 'realm', 'curse', 'unknown'];
      const typeNames = { shikigami: '式神', summon: '召唤物', spell: '法术', battle: '战斗', form: '形态', realm: '幻境', curse: '灵咒', unknown: '其他' };
